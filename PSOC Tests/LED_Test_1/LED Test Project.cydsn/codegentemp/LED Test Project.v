// ======================================================================
// LED Test Project.v generated from TopDesign.cysch
// 05/12/2019 at 11:45
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("46f710a5-d095-449d-9e56-057fb35a0bb3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_sync(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("f54355f2-feef-4874-bce0-9927fb4aa328"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_sync(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("9e97c0a3-4bd4-4de1-bbb8-1a953aeb10d7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_sync(1'b1),
