...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480001ACu)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480001B8u)
...
uint8 CYXDATA * const CYCODE ADCMux_CYAMUXSIDE_A__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADCMux_CYAMUXSIDE_A__maskTable[2] = {
	0x01u, 
	0x10u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE ADCMux_CYAMUXSIDE_B__addrTable[2] = {
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADCMux_CYAMUXSIDE_B__maskTable[2] = {
	0x02u, 
	0x20u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE CurrentMux__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_DAC3_SW3, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CYREG_DAC3_SW4, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CurrentMux__maskTable[4] = {
	0x80u, 0x00u, 
	0x10u, 0x10u, 
};
