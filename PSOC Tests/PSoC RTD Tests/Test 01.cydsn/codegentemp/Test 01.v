// ======================================================================
// Test 01.v generated from TopDesign.cysch
// 06/07/2019 at 12:55
...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("0c0f73f5-b0a0-4432-995d-60f6a0560fa4/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("0c0f73f5-b0a0-4432-995d-60f6a0560fa4/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
    ...
    cy_annotation_universal_v1_0 RTD_PT1000 (
        .connect({
            Net_108,
            Net_142
        })
    );
    defparam RTD_PT1000.comp_name = "Resistor_v1_0";
    defparam RTD_PT1000.port_names = "T1, T2";
    defparam RTD_PT1000.width = 2;
    ...
    UART_v2_50_2 UART_1 (
        ...
        .reset(1'b0),
        .rx(1'b0),
        .tx_interrupt(Net_123),
        .rx_interrupt(Net_124),
        .tx_data(Net_125),
        .tx_clk(Net_126),
        .rx_data(Net_127),
        .rx_clk(Net_128));
	...
	wire [0:0] tmpOE__RTD_Current_net;
	wire [0:0] tmpFB_0__RTD_Current_net;
	wire [0:0] tmpIO_0__RTD_Current_net;
	wire [0:0] tmpINTERRUPT_0__RTD_Current_net;
	electrical [0:0] tmpSIOVREF__RTD_Current_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_Current
		 (.oe(tmpOE__RTD_Current_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_Current_net[0:0]}),
		  .analog({Net_95}),
		  .io({tmpIO_0__RTD_Current_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_Current_net),
		  .interrupt({tmpINTERRUPT_0__RTD_Current_net[0:0]}),
		  .annotation({Net_142}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTD_Current_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__R_ref_current_net;
	wire [0:0] tmpFB_0__R_ref_current_net;
	wire [0:0] tmpIO_0__R_ref_current_net;
	wire [0:0] tmpINTERRUPT_0__R_ref_current_net;
	electrical [0:0] tmpSIOVREF__R_ref_current_net;

	cy_psoc3_pins_v1_10
		#(.id("b9a48fa3-03db-4ccc-ab8f-3a80d9cd653b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		R_ref_current
		 (.oe(tmpOE__R_ref_current_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_ref_current_net[0:0]}),
		  .analog({Net_96}),
		  .io({tmpIO_0__R_ref_current_net[0:0]}),
		  .siovref(tmpSIOVREF__R_ref_current_net),
		  .interrupt({tmpINTERRUPT_0__R_ref_current_net[0:0]}),
		  .annotation({Net_109}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__R_ref_current_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTD_positive_net;
	wire [0:0] tmpFB_0__RTD_positive_net;
	wire [0:0] tmpIO_0__RTD_positive_net;
	wire [0:0] tmpINTERRUPT_0__RTD_positive_net;
	electrical [0:0] tmpSIOVREF__RTD_positive_net;

	cy_psoc3_pins_v1_10
		#(.id("373f7a93-cfae-4561-9299-b16cf02e99a5"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_positive
		 (.oe(tmpOE__RTD_positive_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_positive_net[0:0]}),
		  .analog({Net_107}),
		  .io({tmpIO_0__RTD_positive_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_positive_net),
		  .interrupt({tmpINTERRUPT_0__RTD_positive_net[0:0]}),
		  .annotation({Net_73}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTD_positive_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTD_negative_net;
	wire [0:0] tmpFB_0__RTD_negative_net;
	wire [0:0] tmpIO_0__RTD_negative_net;
	wire [0:0] tmpINTERRUPT_0__RTD_negative_net;
	electrical [0:0] tmpSIOVREF__RTD_negative_net;

	cy_psoc3_pins_v1_10
		#(.id("8471f299-3371-4d9d-88c6-8ff4a82f833e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_negative
		 (.oe(tmpOE__RTD_negative_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_negative_net[0:0]}),
		  .analog({Net_102}),
		  .io({tmpIO_0__RTD_negative_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_negative_net),
		  .interrupt({tmpINTERRUPT_0__RTD_negative_net[0:0]}),
		  .annotation({Net_108}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTD_negative_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__R_ref_positive_net;
	wire [0:0] tmpFB_0__R_ref_positive_net;
	wire [0:0] tmpIO_0__R_ref_positive_net;
	wire [0:0] tmpINTERRUPT_0__R_ref_positive_net;
	electrical [0:0] tmpSIOVREF__R_ref_positive_net;

	cy_psoc3_pins_v1_10
		#(.id("a1a2d0c5-1c2f-403b-a7a6-036620beb2b8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		R_ref_positive
		 (.oe(tmpOE__R_ref_positive_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_ref_positive_net[0:0]}),
		  .analog({Net_104}),
		  .io({tmpIO_0__R_ref_positive_net[0:0]}),
		  .siovref(tmpSIOVREF__R_ref_positive_net),
		  .interrupt({tmpINTERRUPT_0__R_ref_positive_net[0:0]}),
		  .annotation({Net_109}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__R_ref_positive_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__R_ref_negative_net;
	wire [0:0] tmpFB_0__R_ref_negative_net;
	wire [0:0] tmpIO_0__R_ref_negative_net;
	wire [0:0] tmpINTERRUPT_0__R_ref_negative_net;
	electrical [0:0] tmpSIOVREF__R_ref_negative_net;

	cy_psoc3_pins_v1_10
		#(.id("67a2e7d4-7a4b-41fb-9e70-8f7a72112131"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		R_ref_negative
		 (.oe(tmpOE__R_ref_negative_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__R_ref_negative_net[0:0]}),
		  .analog({Net_131}),
		  .io({tmpIO_0__R_ref_negative_net[0:0]}),
		  .siovref(tmpSIOVREF__R_ref_negative_net),
		  .interrupt({tmpINTERRUPT_0__R_ref_negative_net[0:0]}),
		  .annotation({Net_111}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__R_ref_negative_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
