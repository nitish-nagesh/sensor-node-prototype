...
*
* \funcusage
*  \snippet RTD_Current_SUT.c usage_RTD_Current_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet RTD_Current_SUT.c usage_RTD_Current_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet RTD_Current_SUT.c usage_RTD_Current_Read  
*******************************************************************************/
...
* preferred RTD_Current_Read() API because the 
* RTD_Current_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet RTD_Current_SUT.c usage_RTD_Current_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: RTD_Current_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use RTD_Current_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - RTD_Current_0_INTR       (First pin in the list)
    *  - RTD_Current_1_INTR       (Second pin in the list)
    *  - ...
    *  - RTD_Current_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet RTD_Current_SUT.c usage_RTD_Current_SetInterruptMode
    *******************************************************************************/
    void RTD_Current_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & RTD_Current_0_INTR) != 0u) 
		{ 
			 RTD_Current_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet RTD_Current_SUT.c usage_RTD_Current_ClearInterrupt
    *******************************************************************************/
